...
struct discard_cmd {
	...
	struct discard_cmd_control *dcc;	/* discard cmd control */
...
struct mot2_stats {
	atomic64_t update_path_invalid_blks_total;
	atomic64_t queue_gen_blks_total;
};
...
struct f2fs_stat_info {
	u64 mot2_update_path_invalid_blks_total;// lch
	u64 mot2_queue_gen_blks_total;// lch
